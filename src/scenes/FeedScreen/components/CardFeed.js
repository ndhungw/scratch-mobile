    ...
    <View style={styles.container} {...rest}>
      <View style={styles.cardMediaArea}>
        <ImageBackground
          ...
          <View style={styles.cardHeader}>
            <View>
              <Avatar source={profileAvatarSrc || AvatarImg} rounded avatarStyle={styles.avatar} />
            </View>
            <View style={styles.authorInfo}>
              <Text style={styles.profileName}>{profileName || RECIPE_PROFILE_NAME_SAMPLE}</Text>
      ...
      <View style={styles.cardContent}>
        <View style={styles.contentTitle}>
          <Text style={styles.contentTitleText}>{title || RECIPE_TITLE_SAMPLE}</Text>

          <CustomizedButton onPress={() => handleToggleLike(id)} activeOpacity={0.8}>
            <HeartIcon fillColor={isLiked ? COLORS.Red : 'none'} />
          </CustomizedButton>
        </View>
        <Text style={styles.contentParagraph}>{description || RECIPE_DESCRIPTION_SAMPLE}</Text>
      </View>
      <View style={styles.cardActions}>
        <View style={styles.actionArea}>
          <Text style={styles.actionAreaText}>{likesCount || RECIPE_LIKES_COUNT_SAMPLE} likes</Text>
          <DotIcon />
