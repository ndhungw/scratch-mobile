  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <CustomizedButton onPress={handleGoBack} style={styles.button} activeOpacity={0.8}>
          <Text style={styles.buttonText}>Go back (pop)</Text>
        </CustomizedButton>
        <CustomizedButton onPress={handleGoNext} style={styles.button} activeOpacity={0.8}>
